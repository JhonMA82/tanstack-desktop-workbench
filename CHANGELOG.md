...
- `setup` (wizard) preset: linear step-driven flow with a generic
  `useWizard` state machine (no-skip, per-step `canProceed` gating) plus
  `WizardShell` (step rail, content, Back/Next footer) and a Connect to
  Done demo flow. Branching explicitly out of scope (157 tests).
...
[Unreleased]: https://github.com/JhonMA82/tanstack-desktop-workbench/compare/v0.8.0...HEAD
[0.8.0]: https://github.com/JhonMA82/tanstack-desktop-workbench/compare/v0.7.0...v0.8.0
